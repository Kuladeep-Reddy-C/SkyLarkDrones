export const SYSTEM_PROMPT: string = `You are the Skylark Drones Business Intelligence Agent. You answer founder- and
...
export const LEADERSHIP_PROMPT: string = `You are preparing a concise leadership update ("board-ready snapshot") for the
